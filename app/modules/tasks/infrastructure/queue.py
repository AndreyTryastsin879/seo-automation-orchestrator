...
SITEMAP_JOB_TIMEOUT_SECONDS = 86400
# Heavy crawls may run for several days while respecting per-site delays.
HEAVY_CRAWL_JOB_TIMEOUT_SECONDS = 7 * 24 * 60 * 60
YANDEX_WEBMASTER_RECRAWL_JOB_TIMEOUT_SECONDS = 86400
INDEXNOW_SUBMIT_JOB_TIMEOUT_SECONDS = 86400
SITE_AUDIT_JOB_TIMEOUT_SECONDS = 3600
JOB_TIMEOUT_BY_TASK_TYPE: dict[str, int] = {
    ...
    "site_audit": SITE_AUDIT_JOB_TIMEOUT_SECONDS,
}
